...
public class warGame {
    ...
    // The original deck that cards will be distributed from
    Deck gameDeck = new Deck();
    // The two decks that represent the players
    Deck playerOne = new Deck();
    Deck playerTwo = new Deck();

    // Sets up a game of War (e.g creates necessary decks and deals cards to each player
    public warGame() {
        ...
        // Prints Player 1's deck size to confirm
    ...
    // The method normalRound plays a normal round of War. Takes no parameters.
    // Note: A normal round involves the comparison of one card per player.
    public void normalRound() {
        ...
        // If the two cards are equal, the game will launch in a War round
        if (playerOneValue == playerTwoValue) {

            // Creates empty arrays for the war round
            // See the warRound header for an explanation of why this is necessary
            ArrayList<Card> empty1 = new ArrayList<>(4);
            ArrayList<Card> empty2 = new ArrayList<>(4);

            // Starts a new war round with the empty arrays and listens for an integer indicating the winner
        ...
        // Prints the players' deck sizes to show the progression of the game
    ...
    // Note: It is possible that a War round will cards that are all equal. In that case, another War round will be
    // launched. In this case, the new War round will need the cards from the previous War round in order to reward
    // the winner. To do this in one method, warRound accepts two arrays containing the cards from the previous round.
    // The first War round launched from the normalRound method passes two empty arrays to represent a lack of
    // previous cards.
    ...
    public int warRound(ArrayList<Card> playerOnePrev, ArrayList<Card> playerTwoPrev) {
        ...
        // Creates arrays for the cards to be played in the War round
